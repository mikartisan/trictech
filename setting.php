<?php
    ...
    if(!isset($_SESSION['login'])){
        ...
        if($getType=="rider") {
            header('Location: ./rider/setting.php');
        }
    }
                            ...
                            <div class="block md:flex">
                                <div class="bg-white h-5/6 w-full md:w-2/5 shadow rounded-lg p-4 mb-4 sm:p-6 sm:mb-0 xl:p-8">
                                    ...
                                    <div class="w-full h-1/2 p-6 block justify-center">
                                        ...
                                        <!-- <button data-bs-toggle="modal" data-bs-target="#clearLog" type="button" class="bg-blue-100 w-full p-4 mb-3 rounded-md text-center hover:text-white hover:bg-blue-200">Clear Activity Logs</button> -->
                                        <!-- <button data-bs-toggle="modal" data-bs-target="#changePass" type="button" class="bg-blue-100 w-full p-4 mb-3 rounded-md text-center hover:text-white hover:bg-blue-200">Change Password</button> -->
                                    </div>
                                </div>
                                ...
                                <div class="w-full shadow rounded-lg md:w-3/5 p-8 bg-white lg:ml-4">
                                    <div class="w-[90%] m-auto">
                                        <div class="flex justify-center md:pt-5">
                                            <img class="w-20 lg:w-52" src="images/logo.png" alt="logo">
                                        </div>
                                        <p class="text-blue-400 text-center text-base md:text-lg">We're on a mission to make every passenger's life safe by providing the tools they need to have a seamless and enjoyable ride.</p> 
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="relative flex-auto p-4" data-te-modal-body-ref>
                                        <form method="POST">
                                                ...
                                                <div
                                                    ...
                                                    <button type="submit" name="clearLog" formAction="./function/deleteAdminLog.php"
