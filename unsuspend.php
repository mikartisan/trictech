    ...
    <div>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white h-48 shadow rounded-lg p-4 sm:p-6 xl:p-8">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Suspended Account</h3>
                                        <span class="text-base font-normal text-gray-500">Give suspended accounts access.</span>
                                    </div>
                                </div>
                                    ...
                                    <table id="table_category" class="display" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="py-3 px-6">Reason For Suspension</th>
                                                <?php if($getType === 'municipality') : ?>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sql = mysqli_query($conn,"SELECT * FROM account WHERE suspension = 'suspended'");
                                                if(mysqli_num_rows($sql) > 0){
                                                    while($row = mysqli_fetch_assoc($sql)){
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td scope="row"><b><?php echo $lname ." ". $fname; ?></b></td>
                                                            <td scope="row">
                                                                <?php echo $address; ?>
                                                            </td>
                                                            <td scope="row">
                                                            ...
                                                            <td scope="row">
                                                                <?php echo $suspension_reason ?? "No Data"; ?>
                                                            </td>
                                                            <?php if($getType === 'municipality') : ?>
                                                                <td>
                                                                    <button onclick="suspendAccount(<?php echo $id; ?>)" type="button" class="bg-blue-400 hover:bg-blue-500 text-white font-bold w-24 text-xs xl:text-xs py-2 px-3 rounded hover:shadow-lg">
        ...
        <script>
            ...
            function suspendAccount(id) {
                Swal.fire({
                    title: 'Unsuspend',
                    text: "Are you sure you want to give access this account?",
                    icon: 'warning',
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    Swal.fire(
                                        ...
                                        window.location.href = `unsuspend.php`; // Reload the page after confirmation
                                    });
                                } else {
                                    Swal.fire(
                                        'Error!',
                                        'Failed to unsuspend account. Please try again.',
                                        'error'
                                    );
                                }
                            }
