            ...
            <div class="mt-5 flex flex-col items-center">
                <div class="w-full flex-1">
                    ...
                    <div class="mx-auto max-w-xs">
                        ...
                        <form method="POST">
                            <p class="text-lg mt-3 text-center">Thank you for your registration! Your account is currently pending approval by an administrator. We are reviewing your information and will notify you via email once your account has been approved.<a href="login.php" class="text-blue-500">  Login here</a></p>
                        </form>
                    </div>
                </div>
            </div>
