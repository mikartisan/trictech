        ...
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div class="mt-5 flex flex-col items-center">
                <div class="w-full flex-1">
                    ...
                    <h3 class="text-2xl mb-6 font-bold text-center">Success</h3>
                    ...
                    <div class="mx-auto max-w-xs">
                        ...
                        <form method="POST">
                            <p class="text-lg mt-3 text-center">We have sent a temporary password to your email address. Please check your inbox.<a href="login.php" class="text-blue-500">  Login here</a></p>
                        </form>
                    </div>
                </div>
            </div>
