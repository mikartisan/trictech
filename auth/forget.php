<?php
    ...
    if(isset($_POST["code"])) {
        ...
        $sql = "UPDATE account SET password='$hash' WHERE vercode = '$code'";
        ...
        if (mysqli_affected_rows($conn) > 0) {
            ...
            $sql = "SELECT * FROM account WHERE vercode ='$code'";
            ...
            $message = 'Your temporary password is: '. $uniqueId ;
            $headers = 'From: jmbdeocampo@bpsu.edu.ph';

            if (mail($email, $subject, $message, $headers)) {
                header("location: forget-success.php");
            } else {
                $error = true;
        ...
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div class="mt-2 flex flex-col items-center">
                <div class="w-full flex-1 ">
                    ...
                    <h3 class="text-2xl mb-6 font-bold text-center">Reset your password</h3>
