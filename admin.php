                        ...
                        <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                                ...
                                <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                            <?php
                                                $totOperator = "SELECT * FROM account WHERE type='admin'";

                                                if ($result = mysqli_query($conn, $totOperator)) {
                                                    // Return the number of rows in result set
                                                    $rowcount = mysqli_num_rows( $result );
                                        ...
                                        <h3 class="text-base font-normal text-gray-500">Administrator</h3>
                                        </div>
                                        <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                            <a href="view/admin-view.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                                View
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                        <?php
                                            $totOperator = "SELECT * FROM account WHERE type='operator'";
                                    ...
                                    <h3 class="text-base font-normal text-gray-500">Active Operator</h3>
                                    </div>
                                    <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                        <a href="view/operator-view.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                            View
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                        <?php
                                            $rider = "SELECT * FROM account WHERE type='rider'";

                                            if ($result = mysqli_query($conn, $rider)) {
                                                // Return the number of rows in result set
                                                $rowcount = mysqli_num_rows( $result );
                                    ...
                                    <h3 class="text-base font-normal text-gray-500">Active Driver</h3>
                                    </div>
                                    <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                        <a href="view/driver-view.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                            View
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                        <?php
                                            $totPassenger = "SELECT * FROM account WHERE type='passenger'";

                                            if ($result = mysqli_query($conn, $totPassenger)) {
                                                // Return the number of rows in result set
                                                $rowcount = mysqli_num_rows( $result );
                                    ...
                                    <h3 class="text-base font-normal text-gray-500">Active Passenger</h3>
                                    </div>
                                    <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                        <a href="view/passenger-view.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                            View
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                        <?php
                                            $suspended = "SELECT * FROM account WHERE suspension='suspended'";

                                            if ($result = mysqli_query($conn, $suspended)) {
                                                // Return the number of rows in result set
                                                $rowcount = mysqli_num_rows( $result );
                                    ...
                                    <h3 class="text-base font-normal text-gray-500">Suspended Accounts</h3>
                                    </div>
                                    <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                        <a href="unsuspend.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                            View
                                        </a>
                                    </div>
                                </div>
