            ...
            <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                ...
                <div class="pt-6 px-4">
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg h-[420px] p-4 sm:p-6 xl:p-8">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Verification List</h3>
                                        <span class="text-base font-normal text-gray-500">This shows the passengers who have submitted their identification for approval. Once approved, they can use the booking service.</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-x-auto rounded-lg">
                                        <div class="align-middle inline-block min-w-full">
                                            <div class="shadow flex justify-center overflow-hidden sm:rounded-lg">
                                                <img class="w-48 mt-4 justify-center h-48" src="./images/id-card.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                <table id="verification_list" class="display" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="py-3 px-6">Name</th>
                                            <th scope="col" class="py-3 px-6">Address</th>
                                            <th scope="col" class="py-3 px-6">Passenger Type</th>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $sql = "SELECT 
                                                ...
                                                account.lname, 
                                                account.address,
                                                booking_verification.verification_id,
                                                booking_verification.passenger_type
                                                FROM account INNER JOIN booking_verification ON account.unique_id = booking_verification.verification_id WHERE account.type = 'passenger' AND booking_verification.verification_status = 'pending'";
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4">
                                                            <form method="GET">
                                                                <!-- Visit Account -->
                                                                <a href="account-approval.php?approval_id=<?php echo $row["verification_id"]; ?>" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-3 rounded hover:shadow-lg focus:bg-blue-600 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
