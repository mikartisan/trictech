    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($stmt) {
            ...
            if ($stmt->execute()) {
                ...
                $message = 'We are delighted to inform you that your application for access to our booking service has been approved. Your account is now officially active and ready for use.';
                $message .= '\n Use Tritech Booking through this link : ' . 'https://sme.absierra.com/';
                ...
                if (mail($getEmail, $subject, $message, $headers)) {
                    ...
                    //Saved Activity Log
                    $activity = "A passenger account has been approved for verification.";
