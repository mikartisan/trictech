                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <!-- Top Performers -->
                                <li>
                                    <a href="top-performer.php" class="text-base text-gray-900 font-normal rounded-lg bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-trophy text-xl text-blue-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 text-blue-600 whitespace-nowrap">Top Performers</span>
                                    </a>
                                </li>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg h-[420px] p-4 sm:p-6 xl:p-8">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Top 10 Performers</h3>
                                        <span class="text-base font-normal text-gray-500">This shows the drivers with the highest rating for the current month.</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-x-auto rounded-lg">
                                        <div class="align-middle inline-block min-w-full">
                                            <div class="shadow flex justify-center overflow-hidden sm:rounded-lg">
                                                <img class="w-48 mt-9 justify-center h-48" src="./images/ranking.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                <div class="relative overflow-x-auto">
                                    <a href="./function/export-performers.php" target="_blank">
                                        <button class="bg-red-400 hover:bg-red-700 text-white font-bold py-1 px-2 mb-3 rounded">
                                            Export to PDF
                                        </button>
                                    </a>
                                    <table class="w-full text-sm text-left rtl:text-right text-gray-700 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                // SQL query to get average rating for each driver_id in the current month
                                                $sql = "SELECT driver_id, AVG(star) AS average_rating, account.fname, account.lname 
                                                        FROM driver_ratings 
                                                ...
                                                // Counter variable to track the top 3 rows
                                                $counter = 0;
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        // Set different background colors for the top 3 rows
                                                        switch ($counter) {
                                                            case 1:
                                                                $rowClass = 'bg-blue-400';
                                                                break;
                                                            case 2:
                                                        ...
                                                        <tr class="<?php echo $rowClass; ?> border-b">
                                                            ...
                                                            <td class="px-6 py-4">
                                                                <form method="GET">
                                                                    <!-- Visit Account -->
                                                                    <button formaction="view-profile.php" name="viewProfile" value="<?php echo $row["driver_id"]; ?>" type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-1 px-3 rounded hover:shadow-lg focus:bg-blue-600 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
