<?php
    ...
    // Insert New User
    if(isset($_POST["addOperatorSubmit"])) {
        $fname = $_POST["fname"]; 
        $lname = $_POST["lname"]; 
        $email = $_POST["email"]; 
        ...
        if($num == 0) {
            if($email==$emailConfirm) {
                $sql = "INSERT INTO `account` (`unique_id`, `fname`, `lname`, `email`, `password`, `position`, `type`, `status`, `date`) VALUES ('$uniqueID', '$fname', '$lname', '$email', '$hash', 'Operator', 'operator', 'activated', '$datetime')";
                $result = mysqli_query($conn, $sql);
                if ($result) {

                    // Code matches, retrieve the email
                    $subject = 'Operator Account for TricTech';
                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <?php if ($getType === 'admin') : ?>
                                    <li>
                                        <a href="operator.php" class="text-base text-gray-900 font-normal rounded-lg bg-gray-100 flex items-center p-2 group">
                                            <i class="fa fa-male text-xl text-blue-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                            <span class="ml-3 flex-1 text-blue-600 whitespace-nowrap">Add Operator</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
            ...
            <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                ...
                <div class="pt-6 px-4">
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 h-52">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Driver Operator</h3>
                                        <span class="text-base font-normal text-gray-500">Create account for operator here.</span>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="relative flex-auto p-4" data-te-modal-body-ref>
                                                                <form method="POST">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <button type="submit" name="addOperatorSubmit"
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                <div class="">
                                    <table id="table_category" class="display" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="py-3 px-6">Operator</th>
                                                <th scope="col" class="py-3 px-6">Email</th>
                                                <th scope="col" class="py-3 px-6">Drivers</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sql = mysqli_query($conn,"SELECT * FROM account WHERE position='operator'");
                                                if(mysqli_num_rows($sql) > 0){
                                                    while($row = mysqli_fetch_assoc($sql)){
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td scope="row"><b><?php echo $fname." ". $lname; ?></b></td>
                                                            <td scope="row"><?php echo $email; ?></td>
                                                            <td scope="row">
                                                            <?php
                                                                $totDriver = "SELECT * FROM operator_drivers WHERE operator_id = '$unique_id'";

                                                                if ($result = mysqli_query($conn, $totDriver)) {
                                                                    // Return the number of rows in result set
                                                                    $rowcount = mysqli_num_rows( $result );
                                                            ...
                                                            <td>
                                                                <form method="POST">
                                                                    <a href="view-profile.php?viewProfile=<?php echo $unique_id;?>" type="submit" class="bg-blue-400 hover:bg-blue-500 text-white font-bold w-16 text-xs xl:text-xs py-2 px-2 rounded hover:shadow-lg"">
