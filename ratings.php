                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <!-- Driver Evaluation -->
                                <li>
                                    <a href="evaluate.php" class="text-base text-gray-900 font-normal rounded-lg bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-male text-xl text-blue-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 whitespace-nowrap text-blue-600">Driver Evaluation</span>
                                    </a>
                                </li>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex justify-between">
                                    ...
                                    <a href="evaluate.php" class="-mt-2 text-md font-bold text-white bg-blue-500 rounded-full px-5 py-2 hover:bg-blue-600">Back</a>
                                </div>
                                ...
                                <div class="flex flex-col mt-2">
                                    <div class="overflow-x-auto rounded-lg">
                                        <div class="w-full h-1/2 p-8 flex justify-center">
                                            <img class="w-32 h-32 rounded-full" src="https://cdn-icons-png.flaticon.com/512/147/147133.png" alt="Rounded avatar">                          
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input disabled value="<?php echo $getDrivEmail; ?>" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" placeholder="email">
                                        </div>
                                        <div class="mb-4">
                                            <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                                                Address
                                            </label>
                                            <input disabled value="<?php echo $getDrivAddress; ?>" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-full-name" type="text" placeholder="Address">
                                        </div>
                                    </div>
                                </div>
                            </div>
