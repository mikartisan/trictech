                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    <i class="fa fa-address-card text-xl text-gray-400 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                            ...
                                            <table id="table_reports" class="display" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php 
                                                            ...
                                                            $sql = mysqli_query($conn, "SELECT * FROM reports WHERE report_by = 'driver' AND passenger_id = '$approval_id'");
                                                            if(mysqli_num_rows($sql) > 0){
                                                                while($row = mysqli_fetch_assoc($sql)){
                                                                    extract($row);

                                                                    //Get User Profile To View
                                                                    $sqlApproval = mysqli_query($conn,"SELECT * FROM account WHERE unique_id = '$driver_id';");
                                                                    if(mysqli_num_rows($sqlApproval) > 0){
                                                                        while($row = mysqli_fetch_assoc($sqlApproval)){
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td scope="row"><b><?php echo $getPassEmail; ?></b></td>
                                                                        <td scope="row"><b><?php echo $getPassContact; ?></b></td>
                                                                        <td scope="row"><b><?php echo $reason; ?></b></td>
                                                                        <td scope="row"><b><?php echo $created_at; ?></b></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                            }
