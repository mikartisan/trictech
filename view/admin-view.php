                            ...
                            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                    <li class="mr-2" role="presentation">
                                        <button class="inline-block p-4 rounded-t-lg border-b-2" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Administrator List</button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <table id="table_log" class="display" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                                <?php 
                                                    //Display all account
                                                    $account = mysqli_query($conn,"SELECT * FROM account WHERE status='activated' AND type = 'admin'");
                                                    if(mysqli_num_rows($account) > 0){
                                                        while($row = mysqli_fetch_assoc($account)){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo ($position == '*') ? 'Chairman' : $position; ?></td>
