<?php
    ...
    if(!isset($_SESSION['login'])){
        ...
        if($getType=="rider") {
            header('Location: ../rider/logs.php');
        }
    }
                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            ...
                            <div class="space-y-2 pt-2">
                                ...
                                <a href="logs.php" class="text-base hover:bg-gray-100 font-normal rounded-lg group transition duration-75 flex items-center p-2">
                                    <i class="fa fa-clock  text-base text-gray-r00 flex-shrink-0 transition duration-75" name="settings-outline"></i>
                                    ...
                                    <table id="table_log" class="display" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Cancelation Reason</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $transaction = mysqli_query($conn,"SELECT * FROM booking WHERE (driver_id='$transaction_id' OR passenger_id='$transaction_id') AND status != 'pending' AND status != 'accepted' AND passenger_id !='' ORDER BY id DESC");
                                                    ...
                                                    while($row = mysqli_fetch_assoc($transaction)){
                                                        ...
                                                        <tr class="text-gray-500">
                                                            ...
                                                            <?php
                                                                if($status === 'destroy') {
                                                                    ?>
                                                                    <th class="border-t-0 px-4 align-middle text-sm font-normal bg-red-200 text-red-600 text-left">
                                                                        Cancelled By Driver
                                                                    </th>
                                                                    <?php
                                                            ...
                                                            ?>
                                                            <th class="border-t-0 px-4 align-middle text-sm font-normal p-4 text-left"><?php echo $decline_note; ?></th>
