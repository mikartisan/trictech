                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <?php if($getType === 'admin') : ?>
                                    <li>
                                        <a href="../view/fare-matrix.php" class="text-base text-gray-900 font-normal rounded-lg bg-gray-100 flex items-center p-2 group ">
            ...
            <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                ...
                <div class="pt-6 px-4">
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 h-68">
                                <div class="mb-1 flex items-center justify-between">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-base font-normal text-gray-500">The New fare for tricycle for hire in Mariveles are as follows:</span>
                                    </div>
                                </div>
                                <div class="mb-4 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full p-6 mt-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
                                    <p class="block text-gray-700 text-base mb-3"><span class="font-bold">1.1 For Regular Fare - Fifteen Pesos (P<?php echo $first_kilometers; ?>).</p>
                                    <p class="block text-gray-700 text-base mb-3"><span class="font-bold">1.2 For Students, Senior Citizen, Persons with Disability (PWD) - <?php echo $discount; ?>% Lower than the regular fare.</p>
                                    <p class="block text-gray-700 text-base mb-3"><span class="font-bold">1.3 For Special Trip - as per service agreement between the Tricycle Driver and the passenger.</p>
                                    <!-- <p class="block text-gray-700 text-base mb-3"><span class="font-bold">1.4 The new fare for tricycle for hire, to be followed by all Tricycle drivers and operators in the Municipality of Mariveles are specified as follows</p> -->
                                </div>
                            </div>
                                ...
                                <div class="">
                                    <table id="table_category" class="display" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php 
                                                //Display all category
                                                $sql = mysqli_query($conn,"SELECT * FROM fare_matrix INNER JOIN fare_and_discount");
...
<div jsname="jXK9ad" class="Z8r5Gb PZPZlf" style="" role="presentation" data-attrid="kc:/music/musical_group:members" data-hveid="CBcQCg" data-ved="2ahUKEwjo8vW9246EAxXESGwGHRj7CBQQkdsBKAR6BAgXEAo">
    <div id="_OPS9Zej2B8SRseMPmPajoAE_53">
        <a href="/search?sca_esv=2275670e6b2072af&amp;hl=en&amp;q=Hyein&amp;stick=H4sIAAAAAAAAAONgFuLVT9c3NCw2NUlOMyvLU4JwSyzzCgySi4u15LOTrfRzS4szkyFkYk58elF-aYFVbmpuUmpR8SJWVo_K1Mw8ACAPUNRJAAAA&amp;sa=X&amp;ved=2ahUKEwjo8vW9246EAxXESGwGHRj7CBQQ9OUBegQIFxAL" style="-webkit-tap-highlight-color: transparent; user-select: none;">
            <wp-grid-tile>
                <div jsname="QRMGrb" class="olSdv"><img jsname="nWzOlc" class="d7ENZc" alt="" data-h="126" data-w="126" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSm4fC7Q1d1b1IRUcIW0SPdyH9ft9Mc0txfTBxeNs0SNrDRBnTUe4LRZAO82XtYtpGVjbI&usqp=CAU" data-ilt="1706947644531"></div>
                <div class="TT9RUc xvTGWb">
                    <div class="JjtOHd">Leng Leng</div>
                    <div class="ellip yF4Rkc AqEFvb"></div>
                </div>
            </wp-grid-tile>
            <div jscontroller="pfdHGb" class="LqkKtf" jsaction="rcuQ6b:npT2md" style="display: flex;"></div>
        </a>
    </div>
</div>