<?php
    ...
    $sqlProfile = mysqli_query($conn,"SELECT * FROM account WHERE id = '$viewProfile';");
                            ...
                            <div class="block md:flex">
                                <div class="bg-white h-5/6 w-full md:w-2/5 shadow rounded-lg p-4 mb-4 sm:p-6 sm:mb-0 xl:p-8">
                                    <div class="flex justify-between">
                                        ...
                                        <a href="drivers.php" class="-mt-2 text-md font-bold text-white bg-blue-500 rounded-full px-5 py-2 hover:bg-blue-600">Back</a>
                                    </div>
                                ...
                                <div class="w-full shadow rounded-lg md:w-3/5 p-8 bg-white lg:ml-4">
                                    <div class="w-[90%] m-auto">
                                        <form action="../function/updatebook.php" method="POST">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Birthdate</label>
                                            ...
                                            <div class="mb-3">
                                                <label for="author" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                                            ...
                                            <div class="mb-3">
                                                <label for="date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Created</label>
