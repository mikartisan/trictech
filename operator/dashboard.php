                            ...
                            <ul class="space-y-2 pb-2">
                                <li>
                                    <form action="#" method="GET" class="lg:hidden">
                                        <lalbel for="mobile-search" class="sr-only">Search</lalbel>
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Driver Performance</h3>
                                        <span class="text-base font-normal text-gray-500">View your driver ratings here.</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-x-auto rounded-lg">
                                        <div class="align-middle inline-block min-w-full">
                                            <div class="shadow flex justify-center overflow-hidden sm:rounded-lg">
                                                <img class="w-48 mt-7 justify-center h-48" src="../images/evaluate.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table id="table_category" class="display" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="py-3 px-6">Average Ratings</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sql = mysqli_query($conn,"SELECT a.*, od.driver_id FROM operator_drivers od
                                                INNER JOIN account a ON od.driver_id = a.unique_id
                                                WHERE od.operator_id = '$unique_id' AND a.position = 'rider' AND status='activated'");
                                                ...
                                                if(mysqli_num_rows($sql) > 0){
                                                    while($row = mysqli_fetch_assoc($sql)){
                                                        ...
                                                        $driver_id = $row['unique_id'];; // Assuming 'id' is the driver's ID in the 'account' table
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td scope="row">
                                                                <?php echo number_format($average_rating, 1); ?> /5 (<?php echo $total_rating; ?> Reviews)
                                                            ...
                                                            <td>
                                                                <form method="POST">
                                                                    <a href="ratings.php?driver_id=<?php echo $driver_id;?>" type="submit" class="bg-blue-400 hover:bg-blue-500 text-white font-bold w-24 text-xs xl:text-xs py-2 px-3 rounded hover:shadow-lg"">
