                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <!-- Dashboard -->
                                <li>
                                    <a href="dashboard.php" class="text-base text-gray-900 font-normal rounded-lg bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-star text-xl text-blue-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 whitespace-nowrap text-blue-600">Driver Ratings</span>
                                    </a>
                                </li>

                                <!-- User -->
                                <li>
                                    <a href="drivers.php" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-male text-xl text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 whitespace-nowrap">Your Drivers</span>
                                    </a>
                                </li>

                                <!-- Account Approval -->
                                <li>
                                    <a href="account-approval.php" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-check text-xl text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 whitespace-nowrap">Account Approval</span>
                                    </a>
                                </li>
                                <!-- Logout -->
                                <div class="lg:hidden">
                            ...
                            <div class="block md:flex">
                                <div class="bg-white h-5/6 w-full md:w-2/5 shadow rounded-lg p-4 mb-4 sm:p-6 sm:mb-0 xl:p-8">
                                    <div class="flex justify-between">
                                        ...
                                        <a href="dashboard.php" class="-mt-2 text-md font-bold text-white bg-blue-500 rounded-full px-5 py-2 hover:bg-blue-600">Back</a>
                                    </div>
                                    ...
                                    <div class="justify-center text-center">
                                        <p class="text-2xl font-semibold block"><?php echo ucwords($getFName) ." ". $getLName; ?></p>
                                        <h3 class="text-gray-600"><?php if($getPosition=="*") { echo "Super User"; }else{ echo ucwords($getPosition); }  ?></h3>
                                    </div>
                                </div>
                                ...
                                <div class="w-full shadow rounded-lg md:w-3/5 p-8 bg-white lg:ml-4">
                                    <div class="w-[90%] m-auto">
                                        <form action="../function/updateProfile.php" method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                <label class="block mb-2 text-sm font-medium text-gray-900" for="profileImage">Profile Picture</label>
                                                <input id="profileImage" name="profileImage" type="file" accept="image/*" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50">
                                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG (MAX. 800x400px).</p>
                                            </div>
                                            <div class="mb-3">
                                                <label for="fname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First Name</label>
                                                <input type="input" name="fname" value="<?php echo $getFName; ?>" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="First Name" autocomplete="off" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="lname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last Name</label>
                                                <input type="input" name="lname" value="<?php echo $getLName; ?>" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Last Name" autocomplete="off" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="birthdate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Birthdate</label>
                                                <input type="date" name="birthdate" value="<?php echo $getBirth; ?>" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Birthdate" autocomplete="off" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                                                <input disabled type="input" name="email" id="email" value="<?php echo $getUser; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Email" autocomplete="off" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="contact" class="block mb-2 text-sm font-medium text-gray-900 ">Contact No.</label>
                                                <input type="input" name="contact" id="contact" value="<?php echo $getContact; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Contact Number" autocomplete="off" required>
                                            </div> 
                                            <div class="mb-3">
                                                <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Address</label>
                                                <input type="input" name="address" id="address" value="<?php echo $getAddress; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Address" autocomplete="off" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Position</label>
                                                <input type="input" disabled name="position" id="position" value="<?php echo $getPosition; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Position" autocomplete="off" required>
                                            </div>
                                            ...
                                            <?php
                                                if($getType == "rider") {
                                                    ?>
                                                    <div class="mb-3">
                                                        <label for="vehicle" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Vehicle Type</label>
                                                        <input type="input" name="vehicle" id="vehicle" value="<?php echo $getVehicle; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Position" autocomplete="off" required>
                                                    </div>
                                                    <?php
                                                }
                                            ?>
                                            ...
                                            <div class="mt-3">
                                                <button type="submit" name="updateProfile" class="inline-block px-6 py-2.5 bg-green-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-green-600 hover:shadow-lg focus:bg-green-600 focus:shadow-lg focus:outline-none focus:ring-0">
                                                    Save
                                                </button>
                                            </div>
                                        </form>
