                                ...
                                <div class="flex flex-col mt-2">
                                    <div class="overflow-x-auto rounded-lg">
                                        ...
                                        <div class="mb-4 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full p-6 mt-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
                                            <p class="block text-gray-700 text-base mb-3"><span class="font-bold">Operator : </span><?php echo $getFirstName . " ". $getLastName; ?></p>
                                                ...
                                                <article class="pt-6 pb-6 border-b border-gray-300">
                                                    <div class="flex items-center mb-4">
                                                        ...
                                                        <div class="font-medium dark:text-white">
                                                            <p class="ml-2"><?php echo $name; ?> <time class="block text-sm text-gray-500 dark:text-gray-400">Joined on <?php echo $getDate ? strftime("%B %d, %Y", strtotime($getDate)) : ""; ?></time></p>
                                                        </div>
                                                    </div>
