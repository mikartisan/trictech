                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            ...
                            <div class="space-y-2 pt-2">
                                <!-- Activity Log -->
                                <a href="logs.php" class="text-base bg-gray-100 font-normal rounded-lg group transition duration-75 flex items-center p-2">
                                    <i class="fa fa-clock  text-base text-blue-600 flex-shrink-0 transition duration-75" name="settings-outline"></i>
                                    <span class="ml-3 text-blue-600">Activity Log</span>
                                </a>
                            ...
                            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                    <li class="mr-2" role="presentation">
                                        <button class="inline-block p-4 rounded-t-lg border-b-2" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Activity Log</button>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <table id="table_log" class="display" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="py-3 px-6">Activity</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                //Display all account
                                                $account = mysqli_query($conn,"SELECT * FROM user_log WHERE status='OK' and activity_id = '$unique_id' ORDER BY id DESC");
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <!-- <script type="text/javascript">
                                                                        document.write(moment("<?php echo $date; ?>").fromNow());
                                                                    </script>  -->
                                                                </td>
                                                            </tr>
                                                            <?php
