<?php
    ...
    $sqlApproval = mysqli_query($conn,"SELECT * FROM account INNER JOIN booking_verification ON account.unique_id = booking_verification.verification_id WHERE unique_id = '$approval_id';");
    if(mysqli_num_rows($sqlApproval) > 0){
        while($row = mysqli_fetch_assoc($sqlApproval)){
            ...
            $getIDType = $row["id_type"];
            $getEmail = $row["email"];
            $getContact = $row["contact"];
            $getBirth = $row["birthdate"];
            $getAddress = $row["address"];
            $getDate = $row["date"];
            $getFronID = $row["front_img"];
            $getBackID = $row["back_img"];
...
<body>
    <div>
                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    <i class="fa fa-address-card text-xl text-blue-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 text-blue-600 whitespace-nowrap">Account Verification
                        ...
                        <div class="container mx-auto py-8">
                            <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 ">
                                <div class="col-span-4 sm:col-span-3">
                                    <div class="bg-white shadow rounded-lg p-6 pb-9">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-700">Passenger</p>
                                            <div class="mt-6 flex flex-wrap gap-1 justify-center">
                                                <button onclick="declinePassenger()" class="bg-red-400 hover:bg-red-500 text-white py-2 px-4 rounded">Decline</button>
                                                <button onclick="approvePassenger()" type="button" class="bg-green-400 hover:bg-green-400 text-white py-2 px-4 rounded">Approve</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-4 sm:col-span-9">
                                    <div class="bg-white w-full shadow rounded-lg p-6">
                                            ...
                                            <div class="text-gray-700">
                                                <div class="grid md:grid-cols-2 text-sm">
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">First Name</div>
                                                        <div class="px-0 md:px-1 py-2"><?php echo $getFirstName; ?></div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Last Name</div>
                                                        <div class="px-0 md:px-1 py-2"><?php echo $getLastName; ?></div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Gender</div>
                                                        <div class="px-0 md:px-1 py-2">Male</div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Contact No.</div>
                                                        <div class="px-0 md:px-1 py-2">+63 <?php echo $getContact; ?></div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Current Address</div>
                                                        <div class="px-0 md:px-1 py-2"><?php echo $getAddress; ?></div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Email.</div>
                                                        <div class="px-0 md:px-1 py-2">
                                                            <a class="text-blue-800" href="mailto:jane@example.com"><?php echo $getEmail;  ?></a>
                                                        </div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Birthday</div>
                                                        <div class="px-0 md:px-1 py-2"><?php echo date("F d, Y", strtotime($getBirth)); ?></div>
                                                    </div>
                                                    <div class="grid grid-cols-2">
                                                        <div class="px-0 md:px-4 py-2 font-bold">Passenger Type</div>
                                                        <div class="px-0 md:px-1 py-2"><?php echo $getUserType; ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center space-x-2 mt-9 mb-5 font-bold text-gray-700 leading-8">
                                                ...
                                                <span class="tracking-wide">Identification Card</span>
                                            </div>
                                            ...
                                            <div>
                                                <div class="mb-5">
                                                    ...
                                                    <label
                                                    for="front-image"
                                                    class="mb-2 block text-sm font-medium text-[#07074D]"
                                                    >
                                                    ID Type
                                                    </label>

                                                    <div class="mt-3 mb-5">
                                                        <p class="font-bold"><?php echo $getIDType; ?></p>
                                                    </div> 
                                                    ...
                                                    <div class="flex items-center justify-center w-full">
                                                        <label for="front-image" class="front-image-label flex flex-col items-center justify-center w-full min-h-96 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 ">
                                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                                <img class="w-full h-[160px] md:h-[430px]" src="passenger/verification/image/<?php echo $getFronID?>" alt="">
                                                            </div>
                                                        </label>
                                                    </div> 
                                                    ...
                                                    <label
                                                    for="back-image"
                                                    class="mb-2 mt-5 block text-sm font-medium text-[#07074D]"
                                                    >
                                                    Back of ID Card
                                                    </label>
                                                    
                                                    <div class="flex items-center justify-center w-full">
                                                        <label for="back-image" class="back-image-label flex flex-col items-center justify-center w-full min-h-96 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100">
                                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                                <img class="w-full h-[160px] md:h-[430px]" src="passenger/verification/image/<?php echo $getBackID?>" alt="">
                                                            </div>
                                                        </label>
                                                    </div>  
                                            </div>
        ...
        <script>
            function approvePassenger() {
                Swal.fire({
                    title: 'Approve Passenger',
                    text: "Are you sure you want to approve this passenger to use booking service?",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: 'approve-verification.php',
                            method: 'POST',
                            data: { 
                                approval_id : "<?php echo $approval_id ?? ""; ?>",
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    Swal.fire(
                                        ...
                                        window.location = "verification-list.php"; // Reload the page after confirmation
                                    });
                                } else {
                                    Swal.fire(
                                        'Error!',
                                        'Failed to approve account. Please try again.',
                                        'error'
                                    );
                                }
                            }
            ...
            function declinePassenger() {
                Swal.fire({
                    title: 'Decline Passenger',
                    text: "Are you sure you want to decline this passenger to use booking service?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    ...
                                    Swal.fire(
                                        'Error!',
                                        'Failed to decline account. Please try again.',
                                        'error'
                                    );
                                }
                            }
