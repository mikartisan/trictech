                            ...
                            <ul class="space-y-2 pb-2">
                                ...
                                <?php if($getType === 'municipality') : ?>
                                    <li>
                                        ...
                                        <i class="fa fa-map text-xl text-gray-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                        <span class="ml-3 flex-1 whitespace-nowrap text-gray-600">Fare Matrix</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if($getType === 'municipality') : ?>
                                    <li>
                                        ...
                                        <span class="ml-3 flex-1 whitespace-nowrap text-blue-600">Suspend Accounts</span>
                                        </a>
                                    </li>
                                <?php endif; ?>
                ...
                <main>
                    <div class="pt-6 px-4">
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white h-48 shadow rounded-lg p-4 sm:p-6 xl:p-8">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Suspend Account</h3>
                                        <span class="text-base font-normal text-gray-500">Temporarily suspends accounts from access.</span>
                                    </div>
                                </div>
                                <div class="flex justify-between mb-3 mt-5">
                                    <a href="unsuspend.php"
                                        class="text-md font-bold text-white text-center bg-blue-500 rounded-full px-5 py-3 w-full hover:bg-blue-600">
                                        <i class="fa fa-eye mr-2" aria-hidden="true"></i>
                                        <span>View Suspended Account</span>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 2xl:col-span-2">
                                <div class="">
                                    <h4 class="text-xl font-bold text-gray-900 mb-5">Reported Driver</h3>
                                    <table id="table_driver" class="display" cellspacing="0">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sql = mysqli_query($conn, "SELECT DISTINCT account.* FROM account INNER JOIN reports ON account.unique_id = reports.driver_id WHERE reports.report_by = 'passenger'");
                                                if(mysqli_num_rows($sql) > 0){
                                                    while($row = mysqli_fetch_assoc($sql)){
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td scope="row"><b><?php echo $lname; ?></b></td>
                                                            <td scope="row"><b><?php echo $fname; ?></b></td>
                                                            <td scope="row">
                                                                <?php echo $address; ?>
                                                            </td>
                                                            <td scope="row">
                                                            ...
                                                            <td>
                                                                <a href="reported-driver.php?account_id=<?php echo $unique_id; ?>" class="bg-blue-400 hover:bg-blue-400 text-white font-bold whitespace-nowrap w-28 text-xs xl:text-xs py-2 px-4 mr-1 rounded hover:shadow-lg">
                                ...
                                <div class="mt-12">
                                    <h4 class="text-xl font-bold text-gray-900 mb-5">Reported Passenger</h3>
                                    <table id="table_passenger" class="display" cellspacing="0">
                                        <thead>
                                            <tr>
                                            <th scope="col" class="py-3 px-6">Last Name</th>
                                                <th scope="col" class="py-3 px-6">First Name</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                //Display all account of rider and passenger
                                                $sql = mysqli_query($conn, "SELECT DISTINCT account.* FROM account INNER JOIN reports ON account.unique_id = reports.passenger_id WHERE reports.report_by = 'driver'");
                                                if(mysqli_num_rows($sql) > 0){
                                                    while($row = mysqli_fetch_assoc($sql)){
                                                        extract($row);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="reported-passenger.php?account_id=<?php echo $unique_id; ?>" class="bg-blue-400 hover:bg-blue-400 text-white font-bold whitespace-nowrap w-28 text-xs xl:text-xs py-2 px-4 mr-1 rounded hover:shadow-lg">
                                                                    <!-- <i class="fa fa-close text-sm" aria-hidden="true"></i> -->
                                                                    View
                                                                </a>
                                                                <!-- <button onclick="suspendAccount(<?php echo $id; ?>, '<?php echo $email; ?>')" type="button" class="bg-red-400 hover:bg-red-400 text-white font-bold w-28 text-xs xl:text-xs py-2 px-3 rounded hover:shadow-lg">
                                                                    <i class="fa fa-close text-sm" aria-hidden="true"></i>
                                                                    Suspend
                                                                </button> -->
                                                            </td>
