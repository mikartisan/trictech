                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            ...
                            <div class="space-y-2 pt-2">
                                ...
                                <a href="logs.php" class="text-base hover:bg-gray-100 font-normal rounded-lg group transition duration-75 flex items-center p-2">
                                    <i class="fa fa-clock  text-base text-gray-500 flex-shrink-0 transition duration-75" name="settings-outline"></i>
                            ...
                            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                    <li class="mr-2" role="presentation">
                                        <button class="inline-block p-4 rounded-t-lg border-b-2" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Transaction Log</button>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                if(mysqli_num_rows($transaction) > 0){
                                                    while($row = mysqli_fetch_assoc($transaction)){
                                                        ...
                                                        <tr class="text-gray-500">
                                                            <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $created_at; ?></th>
                                                            <?php
                                                                if($status === 'destroy') {
                                                                    ?>
                                                                    ...
                                                                    ?>
                                                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap bg-blue-200 text-blue-600 text-left">Completed</th>
                                                                    <?php
                                                                }
                                                            ?>
