...
<body class="bg-gray-50" onload="getMyLocation()">
    <div>
                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <!-- Fare Estimation -->
                                <li>
                                    <a href="fare.php" class="text-base text-gray-900 font-normal rounded-lg bg-gray-100 hover:bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-location text-xl text-blue-600 flex-shrink-0 group-hover:text-gray-900 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 text-blue-600 whitespace-nowrap">Fare Estimation</span>
                                    </a>
                                </li>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Going somewhere?</h3>
                                        <span class="text-base font-normal text-gray-500">Check the fare</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="align-middle inline-block min-w-full">
                                            ...
                                            <div class="shadow overflow-hidden sm:rounded-lg">
                                                ...
                                                <div class="flex justify-between mb-3">
                                                    <button type="button" onclick="calcFastestRoute()" class="text-md font-bold text-white bg-blue-500 rounded-full px-5 py-3 w-full hover:bg-blue-600"><i class="fa fa-location-arrow" aria-hidden="true"></i> Calculate</button>
                                                </div>
        ...
        <script src="../js/fare-module.js"></script>
