...
<body class="bg-gray-50">
    <?php
        ...
        //Get Driver's Operator
        $sqlOperator = mysqli_query($conn,"SELECT* FROM operator_drivers WHERE driver_id = '$driverID'");
        if(mysqli_num_rows($sqlOperator) > 0){
            while($row = mysqli_fetch_assoc($sqlOperator)){
                $getOperatorID = $row["operator_id"];
            }
        }
    ?>
    <div>
                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    <span class="ml-3 flex-1 text-blue-600 whitespace-nowrap">Booking</span>
                                    </a>
                                </li>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                ...
                                <div class="flex justify-between">
                                        <span class="text-xl font-semibold block">Driver Information</span>
                                        <a href="booking.php" class="-mt-2 text-md font-bold text-white bg-blue-500 rounded-full px-5 py-2 hover:bg-blue-600">Back</a>
                                    </div>

                                <span class="text-gray-600">View driver information here.</span>
                                <div class="flex flex-col mt-2">
                                    <div class="overflow-x-auto rounded-lg">
                                        ...
                                        <div class="mb-4 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full p-6 mt-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
                                            <p class="block text-gray-700 text-base mb-3"><span class="font-bold">Operator : </span>
                                                <?php
                                                    // Display Driver's Operator
                                                    $sqlOperator = mysqli_query($conn, "SELECT * FROM account WHERE unique_id = '$getOperatorID'");
                                                    $operatorRow = mysqli_fetch_assoc($sqlOperator);
                                                    $operatorName = $operatorRow ? $operatorRow['fname'] . ' ' . $operatorRow['lname'] : "Not Available";
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <article class="pt-6 pb-6 border-b border-gray-300">
                                                    <div class="flex items-center mb-4">
                                                        <img class="w-10 h-10 rounded-full" src="../images/profile/<?php echo $getProfileImg ?? "profile.png"; ?>" alt="Rounded avatar">                          
