                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <!-- Points & Rewards -->
                                <!-- <li>
                                <a href="rewards.php" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 bg-gray-100 group">
                                    <i class="text-xl text-blue-600 flex-shrink-0 transition duration-75 fa fa-star" aria-hidden="true"></i>
                                    <span class="ml-3 text-blue-600">Points & Rewards</span>
                                    </a>
                                </li> -->
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Points Reward Page</h3>
                                        <span class="text-base font-normal text-gray-500">Check your points and rewards here.</span>
                                    </div>
                                </div>
                                <div class="flex flex-col mt-2">
                                    <div class="overflow-x-auto rounded-lg border-2 border-blue-200 p-4">
                                        <div class="flex justify-center">
                                            <img class="w-9 h-9 float-left" src="../images/coin.png" alt="coin">
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                <div class="">
                                    <table id="table_category" class="display" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="py-3 px-6">Vouchers</th>
                                                <th scope="col" class="py-3 px-6">Expirations</th>>
                                                <th scope="col" class="py-3 px-6">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <!-- <?php 
                                                // $sql = mysqli_query($conn,"SELECT * FROM parcel WHERE email='$getUser' and status='pending'");
                                                // if(mysqli_num_rows($sql) > 0){
                                                //     while($row = mysqli_fetch_assoc($sql)){
                                                //         extract($row);
                                                        ?>
                                                        <tr>
                                                            <td scope="row"><b><?php echo $recipient; ?></b></td>
                                                            <td scope="row"><?php echo $address; ?></td>
                                                            <td scope="row">₱ <?php echo $amount; ?></td>
                                                            <td>
                                                                <form method="POST">
                                                                    <button name="delivered" formaction="../function/markDelivered.php" value="<?php echo $id; ?>" type="submit" class="bg-green-400 hover:bg-green-500 text-white font-bold w-24 text-xs xl:text-xs py-1 px-3 rounded hover:shadow-lg" onclick="return confirm('Confirm delivery of parcel?')">
                                                                        <i class="fa fa-check text-sm" aria-hidden="true"></i>
                                                                        Delivered
                                                                    </button>
                                                                    <button name="failed" formaction="../function/failedDeliver.php" value="<?php echo $id; ?>" type="submit" class="bg-red-400 hover:bg-red-500 text-white font-bold w-24 mt-2 md:mt-0 md:w-[80px] text-xs xl:text-xs py-1 px-3 rounded hover:shadow-lg" onclick="return confirm('Confirm parcel not delivered?')">
