<?php
    ...
    $sqlUser = mysqli_query($conn,"SELECT * FROM account INNER JOIN booking_verification ON booking_verification.verification_id = account.unique_id WHERE account.unique_id = '$unique_id';");
    if(mysqli_num_rows($sqlUser) > 0){
        while($row = mysqli_fetch_assoc($sqlUser)){
            $getFirstName = $row["fname"];
            $getPosition = $row["position"];
            $getType = $row["type"] ?? "Regular";
    ...
    if(!isset($_SESSION['login'])){
        ...
        }else if($verification_status === 'NO') {
    ...
    //to unset session for rider id when going to next page (assign-parcel.php)
                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    <i class="fa fa-motorcycle text-xl text-blue-600 flex-shrink-0 group-hover:text-gray-900 transition duration-75" aria-hidden="true"></i>
                                ...
                                <!-- Points & Rewards -->
                                <!-- <li>
                                <a href="rewards.php" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                                    <i class="text-xl flex-shrink-0 text-gray-500 transition duration-75 fa fa-star" aria-hidden="true"></i>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        ...
                                        <span class="text-base font-normal text-gray-500">A nearest driver is at the top of your list, based on your current location.</span>
                                    </div>
                                </div>
                                <div class="flex flex-col mt-2">
                                    <div class="overflow-x-auto rounded-lg">
                                        <div class="align-middle inline-block min-w-full">
                                            <div class="shadow flex justify-center overflow-hidden sm:rounded-lg">
                                                <img class="w-48 mt-9 justify-center h-48" src="../images/evaluate.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2 h-[580px] overflow-y-auto"">
                                <!-- Add these hidden input fields in your HTML form -->
                                <input type="hidden" name="myLatitude" id="myLatitude" value="">
                                <input type="hidden" name="myLongitude" id="myLongitude" value="">

                                <div id="booking-data">
                                    <!-- Show the list of driver here -->
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- <div class="bg-white md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
                        <div class="w-full p-3">
                            <p class="font-bold text-xl">Recommendations</p>
                        </div>
                        <div class="w-full">
                            <div class="flex overflow-x-auto space-x-4"> -->
                                
                                <?php
                                //     $getRider = "SELECT * FROM booking INNER JOIN account ON booking.driver_id = account.unique_id WHERE booking.status='pending'";
                                //     // Prepare statement
                                ...
                                //             ?>
                                              ...
                                              <!-- First Div -->
                                <!-- //             <div class="flex-shrink-0 w-96 h-80 bg-gray-50 rounded-lg pt-2 pl-7">
                                ...
                                //                         <p><span class="font-bold">Average Ratings : </span> <?php echo number_format($average_rating, 1); ?> 
                                //                             <i class="mr-2 text-base fa fa-star text-yellow-300" aria-hidden="true"></i>
                                //                         </p>
                                //                     </div>
                                //                     <a href="destination.php?driver_id=<?php echo $driver_id; ?>&booking_id=<?php echo $booking_id; ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold mr-2 mt-2 py-2 px-12 rounded">
                                //                         Book Now
                                //                     </a>  
                                //                     <a href="driver.php?driver_id=<?php echo $driver_id; ?>" class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-500 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-purple-200">
                                //                         View
                                //                     </a>   
                                //                 </article>
                                //             </div> -->
        ...
        <script>
            $(document).ready(function() {
                ...
                function getBookings() {
                    $.ajax({
                    url: 'get-bookings.php', // Replace with your script to fetch bookings
                    method: 'GET',
                ...
                getBookings();
                setInterval(getBookings, 5000); // Fetch bookings every 5 seconds
            });

            // Inside your getMyLocation function
                        ...
                        function(position) {
                            ...
                            fetch(geocodingApiUrl)
                                ...
                                .then(data => {
                                    ...
                                    // Set the user's location in the hidden input fields
