                    ...
                    <main>
                        <div class="flex items-center justify-center p-12">
                            ...
                            <div class="mx-auto w-full max-w-[550px]">
                                <form action="submit-identity.php" method="post" enctype="multipart/form-data" id="identity-form">
                                    <div class="w-full px-3 py-3 sm:w-1/2 rounded-md">
                                        <div class="mb-5">
                                            <label
                                            for="fName"
                                            ...
                                            <select id="id-type" name="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                ...
                                                <option value="Foreign Passport">Non-Philippine/Foreign Passport</option>
                                                <option value="SSS">Social Security System (SSS)</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="w-full px-3 py-3 mb-5 sm:w-1/2 rounded-md">
                                        <div class="mb-5">
                                            <label
                                            for="fName"
                                            class="mb-3 block text-base font-medium text-[#07074D]"
                                            >
                                            Identity Verifaction
                                            </label>
                                            ...
                                            <div class="flex items-center justify-center w-full">
                                                <label for="front-image" class="front-image-label flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                                    ...
                                                    <input id="front-image" name="frontImage" type="file" class="hidden" accept="image/*"/>
                                                </label>
                                            </div> 
                                            ...
                                            <div class="flex items-center justify-center w-full">
                                                <label for="back-image" class="back-image-label flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                        <svg class="w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                                                        </svg>
                                                        <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop</p>
                                                        <p class="front-image-text text-xs text-gray-500 dark:text-gray-400">SVG, PNG, JPG (MAX. 800x400px)</p>
                                                    </div>
                                                    <input id="back-image" name="backImage" type="file" class="hidden" accept="image/*" />
                                                </label>
                                            </div>  
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="flex items-center space-x-6">
                                            <div class="flex items-center">
                                                ...
                                                <label
                                                for="radioButton1"
                                                class="pl-2 text-base font-medium text-[#07074D]"
                                                >
                                                Regular
                                                </label>
                                            </div>
