        ...
        <div class="flex overflow-hidden bg-white pt-16">
            ...
            <div class="bg-gray-900 opacity-50 hidden fixed inset-0 z-10" id="sidebarBackdrop"></div>
                <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                    <main>
                        <section class="bg-white pt-48 pb-48 lg:pb-14 lg:pt-14">
                            <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
                                <ion-icon class="mx-auto mb-4 w-14 h-14 text-gray-400" name="time-outline"></ion-icon>
                                <h1 class="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 lg:mb-6 md:text-5xl xl:text-6xl dark:text-white">Verification Submitted</h1>
                                <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Your account verification is in progress. We carefully review all submissions to ensure security. You can expect a decision within 3-7 business days.</p>
                            </div>
                        </section>
                    </main>
