<?php
    ...
    $sqlUser = mysqli_query($conn,"SELECT * FROM account INNER JOIN booking_verification WHERE account.unique_id = '$unique_id';");
    ...
    <div>
        ...
        <div class="flex overflow-hidden bg-white pt-16">
            ...
            <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                <main>
                    <div class="lg:px-24 lg:py-24 md:py-20 md:px-44 px-11 py-6 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
                        
                        <div class="xl:pt-24 h-[230px] w-full xl:w-1/2 relative pb-12 lg:pb-0">
                            <div class="relative">
                                <div class="absolute">
                                    <div class="">
                                        ...
                                        <p class="my-2 text-gray-800">
                                            We apologize for the inconvenience, but we need to verify your information before you can use our tricycle booking service. 
                                        </p>
                                        <br>
                                        <a href="verify.php" class="sm:w-full lg:w-auto my-2 border rounded md py-4 px-8 text-center bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50">Verify</a>
                                    </div>
                                </div>
                                <div>
                        ...
                        <div>
                            <img class="w-[250px] h-[250px] xl:w-[500px] xl:h-[500px]" src="../../images/validate.png" />
                        </div>
                    </div>
                </main>
