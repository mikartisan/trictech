                    ...
                    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <!-- Dashboard -->
                                <li>
                                    <a href="dashboard.php" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 bg-gray-100 group">
                ...
                <main>
                    <div class="pt-6 px-4">
                        <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                            <!-- <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                        <?php
                                            // $sql = "SELECT SUM(points) as points FROM rewards WHERE passenger_id ='$unique_id'";
                                            // $result = $conn->query($sql);

                                            // if ($result->num_rows > 0) {
                                            //     while($row = $result->fetch_assoc()) {
                                            //         echo number_format($row["points"], 1);
                                            //     }
                                            // } else {
                                            //     echo "0";
                                            // }
                                    ...
                                    <h3 class="text-base font-normal text-gray-500">Total Points</h3>
                                    </div>
                                    <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                        <a href="rewards.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                            View
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-2xl sm:text-3xl leading-none font-bold text-gray-900">
                                        <?php
                                            $sql = "SELECT status, COUNT(*) as ridden FROM booking WHERE passenger_id='$unique_id' AND status='completed'";
                                            $result = $conn->query($sql);
                                            ...
                                            if ($result) {
                                                ...
                                                // Access the 'ridden' column from the result
                                                $riddenCount = $row['ridden'];

                                                echo "$riddenCount";
                                            }
                                        ?>
                                    </span>
                                    <h3 class="text-base font-normal text-gray-500">Trycicles Ridden</h3>
                                    </div>
                                    <!-- <div class="ml-5 w-0 flex items-center justify-end flex-1 text-green-500 text-base font-bold">
                                        <a href="inventory.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                            View
                                        </a>
                                    </div> -->
                                </div>
                            ...
                            <!-- <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center">
                                    ...
                                    <h3 class="text-base font-normal text-gray-500">Income</h3>
                                    </div>
                                    <div class="ml-5 w-0 flex items-center justify-end flex-1 text-red-500 text-base font-bold">
                                        <div>
                                            <a href="#" id="dropdownDefault" data-dropdown-toggle="dropdownReport"  class="text-sm font-medium text-blue-600 bg-gray-100 hover:bg-gray-200 rounded-lg inline-flex items-center p-2">
                                                Generate Report
                                            </a>
                                            Dropdown Report
                                            <div id="dropdownReport" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                                                    <li>
                                                        <a href="../report/rider-income.php" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Income</a>
                                                    </li>
                                                    <li>
                                                        <a href="../report/rider-pending.php" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pending</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="flex items-center justify-between">
                                    <h3 class="text-xl font-bold leading-none text-gray-900">Emergency Contact</h3>
                                    <button id="addRelatives" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                        ADD
                                    </button>
                                </div>
                                <div class="mb-2">
                                    <span class="text-base font-normal text-gray-500">This contacts will be notify in case of an emergency.</span>
                                </div>
                                <div class="block w-full overflow-x-auto">
                                    <div class="max-h-80 overflow-y-auto"> 
                                        <table class="items-center w-fu ll bg-transparent border-collapse">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Relationship</th>
                                            ...
                                            <tbody class="divide-y divide-gray-100">
                                                <?php 
                                                    //Display all pending deliviries
                                                    $relatives = mysqli_query($conn,"SELECT * FROM emergency_contacts WHERE unique_id = '$unique_id'");
                                                    if(mysqli_num_rows($relatives) > 0){
                                                        while($row = mysqli_fetch_assoc($relatives)){
                                                            extract($row);
                                                            ?>
                                                                <tr class="text-gray-500">
                                                                    <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $name; ?></th>
                                                                    <td class="border-t-0 px-4 align-middle text-xs font-medium text-gray-900 whitespace-nowrap p-4"><?php echo $relationship; ?></td>
                                                                    <td class="border-t-0 px-4 align-middle text-xs font-medium text-gray-900 whitespace-nowrap p-4"><?php echo $email; ?></td>
                                                                    <td class="border-t-0 px-4 align-middle text-xs font-medium text-gray-900 whitespace-nowrap p-4"><?php echo $contact; ?></td>
                                                                    <td class="border-t-0 px-4 align-middle text-xs font-medium text-gray-900 whitespace-nowrap p-4">
                                                                        <button class="delete-btn bg-red-400 hover:bg-red-500 text-white font-bold py-1 px-3 rounded" data-id="<?php echo $id; ?>">Remove</button>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                        }
                            ...
                            <div class="bg-white shadow rounded-lg p-4 mb-4 mt-4 sm:mt-0 sm:p-6 sm:mb-0 xl:p-8 ">
                                <div class="flex items-center justify-between mb-6">
                                    <h3 class="text-xl font-bold leading-none text-gray-900">Booking Transactions</h3>
                                    <a href="transaction.php" class="text-sm font-medium text-cyan-600 hover:bg-gray-100 rounded-lg inline-flex items-center p-2">
                                    View all
                                    </a>
                                </div>
                                <div class="block w-full overflow-x-auto">
                                        ...
                                        <table class="items-center w-full bg-transparent border-collapse">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Driver</th>
                                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Distance</th>
                                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Estimated Fare</th>
                                                    <!-- <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Origin</th>
                                                    <th class="px-4 bg-gray-50 text-gray-700 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">Destination</th> -->
                                                </tr>
                                            </thead>
                                            <tbody class="divide-y divide-gray-100">
                                                <?php 
                                                    //Display all delivered parcel
                                                    $transaction = mysqli_query($conn,"SELECT booking.created_at, booking.distance, booking.estimated_fare, booking.status, booking.passenger_origin, booking.passenger_destination, account.fname, account.lname FROM booking INNER JOIN account ON booking.passenger_id = account.unique_id WHERE booking.passenger_id='$unique_id' AND booking.status != 'pending' AND booking.status != 'accepted' AND booking.passenger_id !='' ORDER BY booking.id DESC");
                                                    if(mysqli_num_rows($transaction) > 0){
                                                        while($row = mysqli_fetch_assoc($transaction)){
                                                            extract($row);
                                                            ?>
                                                            <tr class="text-gray-500">
                                                                <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $formattedDateTime = date('F j, Y g:i A', strtotime($created_at)); ?></th>
                                                                <?php
                                                                    if($status === 'destroy') {
                                                                        ?>
                                                                        <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap bg-red-200 text-red-600 text-left">Declined</th>
                                                                        <?php
                                                                    } else if($status === 'completed'){
                                                                        ?>
                                                                        <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap bg-blue-200 text-blue-500 text-left">Completed</th>
                                                                        <?php
                                                                    }
                                                                ?>
                                                                <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $fname ." ". $lname; ?></th>
                                                                <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $distance; ?></th>
                                                                <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left">₱<?php echo $estimated_fare ."- ₱". ($estimated_fare + 5); ?></th>
                                                                <!-- <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $passenger_origin; ?></th>
                                                                <th class="border-t-0 px-4 align-middle text-sm font-normal whitespace-nowrap p-4 text-left"><?php echo $passenger_destination; ?></th> -->
                ...
                $('#addRelatives').click(function () {
                    Swal.fire({
                        ...
                        <div class="flex flex-col">
                            <div class="mb-4">
                            <input class="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Full Name">
                            </div>
                            <div class="mb-4">
                            <input class="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="relationship" type="text" placeholder="Relationship">
                            </div>
                            <div class="mb-4">
                            <input class="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Email Address">
                            </div>
                            <div class="mb-4">
                            <input class="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="contact" type="number" placeholder="Contact Number">
                            </div>
                        </div>
                        `,
                        ...
                        preConfirm: function () {
                            ...
                            if (!name || !relationship || !email || !contact) {
                                Swal.showValidationMessage('Please fill in all required fields');
                                return false;
                            }

                            // Send AJAX request to PHP script with all three data points
                            $.ajax({
                                url: 'add-emergency.php', // Replace with your actual PHP script URL
                                method: 'POST',
                                data: {
                                    name: name,
                                ...
                                success: (response) => {
                                    ...
                                    if (result.message === 'success') {
                                        Swal.fire({
                                            ...
                                            text: 'The emergency contact has been added to your list.',
                                            icon: 'success',
                                        }).then(function () {
                                            location.reload();
                                        });
                                        ...
                                        Swal.fire({
                                        title: 'You can add up to 2 relatives only.',
