                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    <i class="fa fa-cube text-xl text-gray-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 whitespace-nowrap text-gray-600">Parcel</span>
                                    </a>
                                </li>

                                <!-- Routing -->
                                <li>
                                    <a href="routing.php" class="text-base text-blue-600 font-normal rounded-lg bg-gray-100 flex items-center p-2 group ">
                                    <i class="fa fa-map text-xl text-blue-600 flex-shrink- transition duration-75" aria-hidden="true"></i>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">Parcel Routing</h3>
                                        <span class="text-base font-normal text-gray-500">Navigate your next location faster.</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="align-middle inline-block min-w-full">
                                            ...
                                            <div class="shadow overflow-hidden sm:rounded-lg">
                                                <form method="POST">
                                                    ...
                                                    <?php
                                                        $query = "SELECT * FROM parcel WHERE status='pending' and email='$getUser'";
                                                        $result = mysqli_query($conn, $query);
                                                        
                                                        // Store the destinations in an array
                                                        $destinationsFromDatabase = array();
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            $destinationsFromDatabase[] = $row['address'];
                                                        }
                                                    ...
                                                    ?>
                                                    <script>
                                                        var destinations = <?php echo json_encode($destinationsFromDatabase); ?>;
                                                    </script>
                                                    ...
                                                    <!-- <div class="flex items-center border-2 py-3 px-2 rounded-2xl mb-4 mt-4">
                                                        ...
                                                        <input type="text" id="to" placeholder="Destination" class="pl-3 w-full outline-none border-none" />
                                                    </div> -->
                                                </form>
                                                
                                                <div class="flex justify-between mb-3">
                                                    <button onclick="calcFastestRoute()" class="text-md font-bold text-white bg-blue-500 rounded-full px-5 py-3 w-full hover:bg-blue-600"><i class="fa fa-location-arrow" aria-hidden="true"></i> Directions</button>
                                                </div>
