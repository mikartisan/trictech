                                ...
                                <div class="w-full shadow rounded-lg md:w-3/5 p-8 bg-white lg:ml-4">
                                    <div class="w-[90%] m-auto">
                                        <form action="../function/updateProfile.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <!-- <div class="mb-3">
                                                <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Plate No.</label>
                                                <input type="input" name="address" id="address" value="<?php echo $getAddress; ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg outline-blue-500 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Plate Number" autocomplete="off" required>
                                            </div> -->
                                            <div class="mb-3">
