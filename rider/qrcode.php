                        ...
                        <div class="flex-1 px-3 bg-white divide-y space-y-1">
                            <ul class="space-y-2 pb-2">
                                ...
                                <li>
                                    ...
                                    <i class="fa fa-qrcode text-xl text-blue-600 flex-shrink-0 transition duration-75" aria-hidden="true"></i>
                                    <span class="ml-3 flex-1 whitespace-nowrap text-blue-600">Generate QR Code</span>
                                    </a>
                                </li>
                        ...
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        <h3 class="text-xl font-bold text-gray-900 mb-2">QR Generator</h3>
                                        <span class="text-base font-normal text-gray-500">Generate your QR Code here</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-x-auto rounded-lg">
                                        <div class="align-middle inline-block min-w-full">
                                            <div class="shadow flex justify-center overflow-hidden sm:rounded-lg">
                                                <img class="w-48 mt-9 justify-center h-48" src="../images/qrcode.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="container mx-auto">
                                        <div class="text-center">
                                            ...
                                            data entered later -->
                                            <img src="../images/qr-display.jpg" class="qr-code border rounded-md w-36 h-36 p-2 mx-auto" />
                                        </div>

                                        <div class="mt-4">
                                            <label for="content" class="block text-sm font-medium text-gray-700">Driver URL :</label>
                                            <!-- Input box to enter the required data -->
                                            <input type="text" size="60" maxlength="60" class="mt-1 p-2 border rounded-md w-full"
                                                id="content" disabled placeholder="Enter url" value="https://sme.absierra.com/passenger/tricycle/action.php?driver_id=<?php echo $unique_id; ?>" />
                                        </div>

                                        <div class="mt-4">
                                            <button id="generate" type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                                Generate
                                            </button>
                                            <button type="button" class="download-button bg-green-500 hidden hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                                                Download QR Code
                                            </button>
                                        </div>
        ...
        <script>
            ...
            $(function () {
                ...
                $('.download-button').click(function () {
                    ...
                    let qrCodeUrl = $('.qr-code').attr('src');

                    // Create a temporary link element
                    let downloadLink = document.createElement('a');
                    downloadLink.href = qrCodeUrl;
                    downloadLink.download = 'qrcode.png';  // Set desired filename
