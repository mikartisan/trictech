    ...
    <div>
                ...
                <div class="pt-6 px-4">
                        <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        ...
                                        <span class="text-base font-normal text-gray-500">Find and accept booking here.</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="align-middle inline-block min-w-full">
                                            <div class="shadow overflow-hidden sm:rounded-lg">
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT * FROM booking WHERE driver_id = ? and status='pending'"; // Assuming a booking_id is available
                                                    $stmt = $conn->prepare($sql);
                                                    $stmt->bind_param("s", $unique_id); // Replace $booking_id with the actual booking ID
                                                    $stmt->execute();
                                                ...
                                                ?>
                                                    ...
                                                    <?php if ($booking_status === "pending"): ?>
                                                        <!-- Booking Status-->
                                                        <div class="flex items-center border-2 border-green-500 text-lg py-2 px-2 rounded-2xl mb-4 mt-4">
                                                            <input type="text" value="PENDING" class="pl-3 font-bold w-full text-green-500 text-center text-lg outline-none border-none" />
                                                        </div>
                                                        <div class="flex justify-between mb-3">
                                                            <button type="button" onclick="cancelFindingBooking()" class="text-md font-bold text-white bg-red-400 rounded-full px-5 py-3 w-full hover:bg-red-500">
                                                            <i class="fa fa-stop-circle" aria-hidden="true"></i> Cancel
                                                            </button>
                                                        </div>
                                                    <?php else: ?>
                                                        <!-- Booking Status-->
                                                        <div class="flex items-center border-2 border-red-500 text-lg py-2 px-2 rounded-2xl mb-4 mt-4">
                                                            <input type="text" value="DISABLED" class="pl-3 font-bold w-full text-red-500 text-center text-lg outline-none border-none" readonly />
                                                        </div>
                                                        <div class="flex justify-between mb-3">
                                                            <button type="button" onclick="findBooking()" class="text-md font-bold text-white bg-blue-500 rounded-full px-5 py-3 w-full hover:bg-blue-600">
                                                                <i class="fa fa-location" aria-hidden="true"></i> Find Booking
                                                            </button>
                                                        </div>
                                                    <?php endif; ?>
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
                                <div>
                                    <div id="booking-data">
                                        <!-- Show the list of passenger here -->
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            function findBooking() {
                Swal.fire({
                    title: 'Booking',
                    text: "Are you sure you want to accept a booking?",
                    icon: 'warning',
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(response) {
                                                    ...
                                                    if (response.status === 'success') {
                                                        ...
                                                        Swal.fire(
                                                            'Error!',
                                                            'Failed to enabled booking. Please try again.',
                                                            'error'
                                                        );
                                                    }
                                                }
            ...
            function cancelFindingBooking() {
                Swal.fire({
                    title: 'Stop Booking',
                    text: "Are you sure you want to stop accepting booking?",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    ...
                                    Swal.fire(
                                        'Error!',
                                        'Decline the booking and please try again.',
                                        'error'
                                    );
                                }
                            }
