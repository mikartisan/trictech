                            ...
                            <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                    <li class="mr-2" role="presentation">
                                        <button class="inline-block p-4 rounded-t-lg border-b-2" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Passenger Reviews</button>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <thead>
                                        ...
                                        <tbody class="divide-y divide-gray-100">
                                            <?php 
                                                ...
                                                $review = mysqli_query($conn,"SELECT * FROM driver_ratings INNER JOIN account WHERE driver_ratings.driver_id = '$unique_id'  ORDER BY driver_ratings.id DESC");
                                                                        ...
                                                                        <div class="font-medium dark:text-white">
                                                                            <p>
                                                                                <?php 
                                                                                    ...
                                                                                    echo $maskedName;
                                                                                ?> 
                                                                                <time class="block text-sm text-gray-500 dark:text-gray-400">Joined on <?php echo $joined ? strftime("%B %d, %Y", strtotime($joined)) : ""; ?></time></p>
                                                                        </div>
                                                                    </div>
