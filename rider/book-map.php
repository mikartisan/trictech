            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="chat.php?passenger_id=<?php echo $passenger_id; ?>&booking_id=<?php echo $booking_id; ?>" class="relative inline-flex items-center p-2 text-sm font-medium text-center text-white bg-blue-400 rounded-lg hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            ...
                            <div id="unreadCount" class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2">
                                <?php
                                    $sql = "SELECT COUNT(*) as unread FROM chats WHERE booking_id = '$booking_id' AND sender = 'passenger' AND seen IS NULL";
                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                ...
                                <div class="flex flex-col mt-1">
                                    <div class="overflow-x-auto rounded-lg">
                                        ...
                                        <?php
                                            $passenger = mysqli_query($conn,"SELECT * FROM account WHERE unique_id = '$passenger_id';");
                                            if(mysqli_num_rows($passenger) > 0){
                                                while($row = mysqli_fetch_assoc($passenger)){
                                                    $getPassFName = $row["fname"];
                                                    $getPassLName = $row["lname"];
                                        ...
                                        <div class="justify-center text-center">
                                            <p class="text-2xl font-semibold block"><?php echo $getPassFName ." ". $getPassLName; ?></>
                                            <h3 class="text-gray-600">Passenger</h3>
                                        </div>
                                        <div class="align-middle inline-block min-w-full">
                                            ...
                                            <div class="shadow overflow-hidden sm:rounded-lg">
                                                <form method="POST">
                                                    ...
                                                    <div>
                                                        <label for="notes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Passenger notes</label>
                                                        <textarea name="notes" rows="3" class="block p-2.5 mb-4 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Passenger notes goes here..." disabled><?php echo $getNotes; ?></textarea>
                                                    </div>
                                                </form>
                                                
                                                <div class="flex justify-between mb-3">
                                                    <button type="button" onclick="completedBooking()" class="text-md font-bold text-white bg-blue-500 rounded-full px-5 py-3 w-full hover:bg-blue-600"><i class="fa fa-check" aria-hidden="true"></i> Completed</button>
                                                </div>
            ...
            function reportDriver() {
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <input type="radio" name="report-reason" value="No Apperance" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500"> No Apperance<br>
                        <input type="radio" name="report-reason" value="Harassment" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500"> Harassment<br>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.status === 'success') {
                                    Swal.fire(
                                        'Driver Reported!',
                                        'The passenger has been reported to the admin.',
                                        'success'
                                    );
                                } else {
                                    Swal.fire(
