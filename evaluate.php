                            ...
                            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                                <div class="mb-1 flex items-center justify-between">
                                    <div>
                                        ...
                                        <span class="text-base font-normal text-gray-500">Evaluate and view driver ratings here.</span>
                                    </div>
                                </div>
                                    ...
                                    <table id="table_category" class="display" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $sql = mysqli_query($conn,"SELECT * FROM account WHERE position='rider'");
